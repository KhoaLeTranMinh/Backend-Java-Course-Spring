...
public class ExampleApplication {
	...
	public static void main(String[] args) {
		...
		CreateTransactionResponse createTransactionResponse1 = transactionService
				.createTransaction(CreateTransactionRequest.builder().userId(user1.getId()).idempotentKey("abc")
						.amount(1).build());
		...
		CreateTransactionResponse createTransactionResponse2 = transactionService
				.createTransaction(CreateTransactionRequest.builder().userId(user1.getId()).idempotentKey("abc1")
						.amount(100).build());
